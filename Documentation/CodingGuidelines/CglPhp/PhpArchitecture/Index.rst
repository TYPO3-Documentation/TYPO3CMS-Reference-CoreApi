...
Best practices and rules of thumb when developing for `TYPO3`:pn:.
...
found in the `TYPO3 Core`:pn: and maybe in third party extensions. It
should help reviewers to evaluate solutions and how they stick to the
main code separation principles the `Core`:pn: tries to follow. The document
