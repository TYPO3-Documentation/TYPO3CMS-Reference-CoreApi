...
files inside :code:`t3lib/` and :code:`typo3/` directories and the file named
:code:`index.php` in the root of the TYPO3 installation.

All other files are user files. This includes extensions, files in the
:code:`fileadmin/` directory or files generated by TYPO3 (like thumbnails or
temporary CSS files).
