...
by the TYPO3 core team. This includes files inside :code:`t3lib/` and
:code:`typo3/` directories and the file named :code:`index.php` in the
root of the TYPO3 installation.
...
files are not allowed in the :code:`typo3/` and :code:`t3lib/` folders.
