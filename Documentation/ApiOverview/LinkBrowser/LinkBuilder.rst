...
:php:`AbstractTypolinkBuilder::build()`. It is called with by the :ref:`link-factory`
with the parameter array provided by the :ref:`Core link handler <core-link-handler>`.
