...
.. figure:: ../../../Images/ErrorHandling/WarningBackend.png
   :alt: PHP warning in the backend

   A PHP warning in the TYPO3 Backend


.. figure:: ../../../Images/ErrorHandling/WarningAdminPanel.png
   :alt: PHP warning in the admin panel

   A PHP exception caught and displayed in the admin panel


.. figure:: ../../../Images/ErrorHandling/DebugExceptionHandler.png
   :alt: Exception caught by debug handler

   An exception shown by the debug exception handler


.. figure:: ../../../Images/ErrorHandling/ProductionExceptionHandler.png
   :alt: Exception caught by production handler

   An exception shown by the production exception handler


.. figure:: ../../../Images/ErrorHandling/WarningBeLog.png
   :alt: PHP errors in the BE log

   PHP exceptions caught and displayed in Admin Tools > Log


.. figure:: ../../../Images/ErrorHandling/WarningDevLog.png
