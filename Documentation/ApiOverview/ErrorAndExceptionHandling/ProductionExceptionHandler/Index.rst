...
-  Shows brief exception message ("Oops, an error occurred!") using
   :php:`\TYPO3\CMS\Core\Messaging\ErrorpageMessage` and its attendant template.
...
-  Logs exception messages to
   ...
   system's log and it can send error- and exception-messages by mail.
   :php:`\TYPO3\CMS\Core\Utility\GeneralUtility::syslog()` offers a hook an can
   be extended by user-defined logging methods.
