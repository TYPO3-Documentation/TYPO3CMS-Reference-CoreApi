...
for example webserver environment variables. The `TYPO3 Core`:pn: ships some basic log processors,
...
This section describes the log processors shipped with the `TYPO3 Core`:pn:.
