...
* :ref:`TypoScript Reference <t3tsref:typoscript-syntax-typoscript-templates>`
* `TSconfig Reference: Useing and setting <https://docs.typo3.org/m/typo3/reference-tsconfig/8.7/en-us/UsingSetting/Index.html>`__ (v8.7).
