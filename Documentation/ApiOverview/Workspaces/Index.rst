...
.. table:: Overview of `pages` records (not all possible scenarios are shown)
...
.. table:: Overview of regular records (e.g. `tx_record`, `tt_content`, ... but not `pages`)
...
.. table:: Page "Topic #1 new" is created with their according placeholders
...
.. table:: Record "Article #1" is modified in workspace
...
.. table:: Record "Article #2" is deleted in workspace
...
.. table:: Record "Article #3" is moved to different page
...
.. table:: Record "Article #4" is created on existing page
...
.. table:: Record "Topic #1 Article" is created on page that is new in workspace
...
.. table:: Previously created record "Article #5" is discarded
...
.. table:: Record "Article #1" is localized to French and German
