...
.. important::
   ...
   Pootle has been superseded by the usage of `Crowdin`:pn: which is described in
   detail at :ref:`xliff-translating-server-crowdin`.

To manage translations of extensions uploaded to the `TYPO3 Extension Repository`:pn: (TER),
...
They can be fetched in the`TYPO3 CMS`:pn: backend, via the Install Tool and on the command line.
