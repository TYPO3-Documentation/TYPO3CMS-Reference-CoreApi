...
Except for some low level functions, the`TYPO3 CMS`:pn: exclusively uses localizable
...
The default language is English, and the `Core`:pn: ships only with such labels (and
