...
:file:`typo3/sysext/beuser/Resources/Private/Templates/BackendUser/List.fluid.html`):

..  code-block:: xml
    :caption: EXT:beuser/Resources/Private/Templates/BackendUser/List.fluid.html (excerpt)
    :emphasize-lines: 2
