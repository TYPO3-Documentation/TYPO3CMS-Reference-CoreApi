...
..  note::
    The parenthesis in the comment of the above example: 
    :php:`->andWhere()` and the TCA restrictions encapsulate 
    the where clause part generated by :php:`->where()` and :php:`->orWhere()` with an internal parenthesis. 
