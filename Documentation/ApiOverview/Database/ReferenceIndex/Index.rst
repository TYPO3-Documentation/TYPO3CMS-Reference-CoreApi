...
Tables can be excluded from the reference index by using the event
`IsTableExcludedFromReferenceIndexEvent <https://docs.typo3.org/permalink/t3coreapi:istableexcludedfromreferenceindexevent>`_.
