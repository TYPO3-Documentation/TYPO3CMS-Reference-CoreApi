...
:ref:`BeforePagePreviewUriGeneratedEvent <BeforePagePreviewUriGeneratedEvent>`.
It allows to overwrite the built preview URI. However, this event does not feature the possibility to modify the
