...
file reference of a TCA type :ref:`file <t3tca:columns-file>` field. This event
is similar to the :ref:`ModifyInlineElementEnabledControlsEvent
<ModifyInlineElementEnabledControlsEvent>`, which is only available for TCA type
