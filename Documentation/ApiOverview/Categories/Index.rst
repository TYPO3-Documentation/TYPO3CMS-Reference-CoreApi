...
.. warning::
   ...
   Implementation of system categories in TYPO3 CMS 6.0 was rather young
   and incomplete. If you really want to use them, please do so rather with
   version 6.1 or even better 6.2, which provides a much richer API.
