...
.. figure:: ../Images/RteBackend.png
   :alt: A RTE in the TYPO3 backend
...
This works for `FlexForms`:pn: too.

.. important::

   Don't forget to enable Rich Text Editor in the backend, in User Settings -> Edit and Advanced functions,
