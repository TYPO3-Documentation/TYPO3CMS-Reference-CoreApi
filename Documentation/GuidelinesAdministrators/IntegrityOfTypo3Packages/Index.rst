...
Wiki (e.g. `http://wiki.typo3.org/wiki/TYPO3\_4.7.0
<http://wiki.typo3.org/wiki/TYPO3_4.7.0>`_ for the official TYPO3
version 4.7.0 packages).
...
sometimes including components such as Apache, MySQL, PHP and TYPO3 CMS,
