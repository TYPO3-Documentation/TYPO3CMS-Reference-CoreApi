...
.. seealso::
   ...
   * A glob pattern is used to set the included files and their path, for example `'../Classes/**'`
     to allow all files beneath the :file:`Classes` folder of a TYPO3 extension.
