...
TYPO3 installation might contain a companies web site and a few landing pages
for special products or events.

Even if your TYPO3 installation only contains one site, this one site needs to
be configured. This includes the domain that can be used to reach the site,
