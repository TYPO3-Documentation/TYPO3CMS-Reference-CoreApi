...
The actual storage structure depends on what Driver each Storage
...
Inside each Storage will be a folder named :file:`_processed_`
...
This folder contains actual files from your older TYPO3 CMS
