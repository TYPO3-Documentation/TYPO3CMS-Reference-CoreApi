...
The setup provided by
`typo3/testing-framework <https://github.com/TYPO3/testing-framework>`_ and
supported by :file:`runTests.sh` and :file:`docker-compose.yml` as outlined in
the :ref:`styleguide example <testing-extensions-styleguide>` is based on
`codeception <https://codeception.com/>`_ and
`selenium <https://www.seleniumhq.org/>`_, usually using chrome as browser. Also
see :ref:`Test runners: organize and execute tests <testing-organization>` for
details on test runners.
