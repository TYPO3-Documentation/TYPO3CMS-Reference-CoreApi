...
`typo3conf/ext` for third party extensions, creates a
:file:`PackageStates.php` and then creates all database tables based on TCA
and complementary :file:`ext_tables.sql` definitions.
