...
return [
    ...
    [
        ...
        'members' => [
            'LOCAL_DOMAIN','TABLE_NAME','FIELD_NAME','__invoke'
        ],
        'withComment' => true,
    ...
    [
        ...
        'class'=> \T3docs\Examples\EventListener\LinkValidator\CheckExternalLinksToLocalPagesEventListener::class,
        'members' => [
            'brokenLinkRepository','softReferenceParserFactory','__construct'
        ],
        'withComment' => true,
        'withClassComment' => false,
    ...
    [
        ...
        'class'=> \T3docs\Examples\EventListener\LinkValidator\CheckExternalLinksToLocalPagesEventListener::class,
        'members' => [
            'LOCAL_DOMAIN','TABLE_NAME','FIELD_NAME','softReferenceParserFactory','parseField', 'findAllParsers'
        ],
        'withComment' => true,
        'withClassComment' => false,
    ...
    [
        ...
        'class'=> \T3docs\Examples\EventListener\LinkValidator\CheckExternalLinksToLocalPagesEventListener::class,
        'members' => [
            'LOCAL_DOMAIN','TABLE_NAME','FIELD_NAME','brokenLinkRepository','matchUrl', 'addItemToBrokenLinkRepository'
        ],
        'withComment' => true,
        'withClassComment' => false,
