...
Installing TYPO3 on a Windows server
====================================
...
Download the TYPO3 source package from `https://get.typo3.org/
<https://get.typo3.org/>`_ and extract the :file:`.zip` file on the server.
...
Use the Windows command shell to create the following symlinks in the document
root:
