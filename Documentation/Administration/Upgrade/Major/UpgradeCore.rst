...
example, the installation is running TYPO3 version 13.4.25 and the new LTS
release is version 14.3.1.
...
:bash:`composer require typo3/cms-backend:^14.3`.
...
..  code-block:: bash
    ...
    "typo3/cms-core:^14.3" "typo3/cms-dashboard:^14.3" "typo3/cms-extbase:^14.3" \
    "typo3/cms-extensionmanager:^14.3" "typo3/cms-filelist:^14.3" "typo3/cms-fluid:^14.3" \
    "typo3/cms-fluid-styled-content:^14.3" "typo3/cms-form:^14.3" "typo3/cms-frontend:^14.3" \
    "typo3/cms-impexp:^14.3" "typo3/cms-info:^14.3" "typo3/cms-install:^14.3" \
    "typo3/cms-lowlevel:^14.3" "typo3/cms-opendocs:^14.3" "typo3/cms-recycler:^14.3" \
    "typo3/cms-redirects:^14.3" "typo3/cms-reports:^14.3" "typo3/cms-rte-ckeditor:^14.3" \
    "typo3/cms-scheduler:^14.3" "typo3/cms-seo:^14.3" "typo3/cms-tstemplate:^14.3" \
...
For example, when upgrading from TYPO3 v13 LTS to v14 LTS an error can occur
stating that `"helhum/typo3-console": "^9.1"` is only compatible with v13 LTS,
with the new version `^10.1` supporting TYPO3 v14 LTS.

For each of these dependency errors, add the version requirement
`"helhum/typo3-console:^10.1"` to the end of your :bash:`composer require` string
