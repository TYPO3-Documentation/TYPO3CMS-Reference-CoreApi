...
*   :php:`\TYPO3\CMS\Backend\Form\FormDataProvider\AbstractDatabaseRecordProvider`,
    ...
    *   Good: The exception hierarchy is relatively flat - it extends from
        a more generic :php:`\TYPO3\CMS\Backend\Form\Exception` which itself extends
        from :php:`\TYPO3\CMS\Backend\Exception` which extends :php:`\Exception`.
        The :php:`\TYPO3\CMS\Backend\Form\Exception` could have been left out, but
