...
..  Ported from old docs: Extbase/Reference/Domain/Model/PropertyTypes/Index.rst
    (whole page). Old anchor: extbase-model-property-types.
...
====================================================  ================================================================  ============================
:ref:`string <extbase-domain-property-types-string>`  `input`, `text`, `email`, `password`, `color`,                    `varchar(255)`, `text`
                                                      `select`, `passthrough`
:ref:`int <extbase-domain-property-types-int>`        `number` (with `format: integer`), `select` with                  `int(11)`, `tinyint(1)`
                                                      numeric values
:ref:`float <extbase-domain-property-types-float>`    `number` (with `format: decimal`)                                 `double`, `float`
:ref:`bool <extbase-domain-property-types-bool>`      `check`                                                           `tinyint(1)`
====================================================  ================================================================  ============================
...
..  tabs::
    ...
    ..  group-tab:: Model
        ...
        ..  literalinclude:: _snippets/_IntExample.php
            :caption: packages/my_extension/Classes/Domain/Model/IntExample.php

    ..  group-tab:: TCA

        ..  literalinclude:: _snippets/_int_example.php
...
-   **Boolean values**: For fields using
    ...
    `bool properties <https://docs.typo3.org/permalink/t3coreapi:extbase-domain-property-types-bool>`_.
...
-   **Enums**: For fixed sets of numeric values, avoid using :php:`int`
    ...
    See `Enumerations <https://docs.typo3.org/permalink/t3coreapi:extbase-domain-property-types-enum>`_.
...
..  tabs::
    ...
    ..  group-tab:: Model
        ...
        ..  literalinclude:: _snippets/_FloatExample.php
            :caption: packages/my_extension/Classes/Domain/Model/FloatExample.php

    ..  group-tab:: TCA

        ..  literalinclude:: _snippets/_float_example.php
...
..  tabs::
    ...
    ..  group-tab:: Model
        ...
        ..  literalinclude:: _snippets/_BoolExample.php
            :caption: packages/my_extension/Classes/Domain/Model/BoolExample.php

    ..  group-tab:: TCA

        ..  literalinclude:: _snippets/_bool_example.php
...
..  tabs::
    ...
    ..  group-tab:: Model
        ...
        ..  literalinclude:: _snippets/_DateExample.php
    ...
    ..  group-tab:: TCA
        ...
        ..  literalinclude:: _snippets/_date_example.php
...
..  tabs::
    ...
    ..  group-tab:: Controller
        ...
        ..  literalinclude:: _snippets/_CountryController.php
    ...
    ..  group-tab:: Model
        ...
        ..  literalinclude:: _snippets/_Country.php
        ...
        `Extbase Validators <https://docs.typo3.org/permalink/t3coreapi:extbase-validation-overview>`__
        for this task.

    ..  group-tab:: TCA

        ..  literalinclude:: _snippets/_country_tca.php
...
..  tabs::
    ...
    ..  group-tab:: Model
        ...
        ..  literalinclude:: _snippets/_EnumModelExample.php
    ...
    ..  group-tab:: Enum
        ...
        ..  literalinclude:: _snippets/_EnumExample.php
    ...
    ..  group-tab:: TCA
        ...
        ..  literalinclude:: _snippets/_enum_example.php
    ...
    ..  group-tab:: Localization
        ...
        ..  literalinclude:: _snippets/_enum_locallang.xlf
            :language: php
...
..  literalinclude:: _snippets/_UnionType1.php
...
:ref:`mapped onto an object <extbase-domain-model-hydration>`. In this situation Extbase
...
..  literalinclude:: _snippets/_UnionType2.php
    :caption: EXT:my_extension/Classes/Domain/Model/Entity.php
...
primary type :php:`string` which is :ref:`nullable <extbase-persistence-relations-to-one>`.
...
..  literalinclude:: _snippets/_UnionType3.php
    :caption: EXT:my_extension/Classes/Domain/Model/Entity.php
...
..  literalinclude:: _snippets/_ObjectStorage.php
    :caption: EXT:my_extension/Classes/Domain/Model/Entity.php
