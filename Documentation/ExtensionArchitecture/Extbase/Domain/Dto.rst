:navigation-title: Data transfer objects
...
..  Ported from old docs: Extbase/Reference/Domain/Model/DataObjects/Index.rst
    (whole page). Old anchor: extbase-dto.
...
..  literalinclude:: _snippets/_MeasurementsDto.php
...
..  literalinclude:: _snippets/_CalculatorController.php
...
..  literalinclude:: _snippets/_MeasurementsDtoValidation.php
    :caption: EXT:bmi_calculator/Classes/Domain/Model/Dto/MeasurementsDto.php
...
the `Error action <https://docs.typo3.org/permalink/t3coreapi:extbase-controller-action-error>`_
...
..  literalinclude:: _snippets/_CalculatorControllerErrorMessage.php
    :caption: EXT:bmi_calculator/Classes/Controller/CalculatorController.php
...
..  literalinclude:: _snippets/_Measurements.php
...
..  literalinclude:: _snippets/_CalculatorControllerSaveModel.php
    :caption: EXT:bmi_calculator/Classes/Controller/CalculatorController.php
...
..  literalinclude:: _snippets/_MeasurementsDtoSerialization.php
...
..  literalinclude:: _snippets/_UserSessionService.php
...
..  literalinclude:: _snippets/_CalculatorControllerSaveSession.php
    :caption: EXT:bmi_calculator/Classes/Controller/CalculatorController.php
